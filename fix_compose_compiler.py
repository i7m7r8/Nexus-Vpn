...
if not root_gradle.exists():
    print(f"Error: {root_gradle} not found", file=sys.stderr)
    sys.exit(1)
...
print("✅ Root build.gradle rewritten with plugins block")
...
print("✅ App build.gradle rewritten with compose compiler plugin")
print("   - Removed composeOptions (no longer needed with new plugin)")
print("   - Added org.jetbrains.kotlin.plugin.compose")
